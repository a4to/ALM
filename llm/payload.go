...
var errPayloadMissing = errors.New("expected payloads not included in this build of alm")
...
// For example, "alm_rocm_v6" and "alm_rocm_v5" or "alm_cpu" and "alm_cpu_avx2"
...
func getAvailableServers() map[string]string {
	...
	// glob payloadsDir for files that start with alm_
	pattern := filepath.Join(payloadsDir, "*", "alm_*")
...
func serversForGpu(info gpu.GpuInfo) []string {
	// glob workDir for files that start with alm_
