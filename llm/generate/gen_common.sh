...
init_vars() {
    ...
    *)
    ...
    CMAKE_DEFS=""
    CMAKE_TARGETS="--target ALM_llama_server"
...
apply_patches() {
    ...
    if ! grep ALM ${LLAMACPP_DIR}/CMakeLists.txt; then
        echo 'add_subdirectory(../ext_server ext_server) # ALM' >>${LLAMACPP_DIR}/CMakeLists.txt
    fi
