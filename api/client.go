...
// with the alm service. The methods of the [Client] type correspond to
// the alm REST API as described in [the API documentation].
// The alm command-line client itself uses this package to interact with
// the backend service.
//
// # Examples
//
...
// repository].
//
// [the API documentation]: https://github.com/a4to/alm/blob/main/docs/api.md
// [in the GitHub repository]: https://github.com/a4to/alm/tree/main/examples
package api
...
import (
	...
	"github.com/a4to/alm/envconfig"
	"github.com/a4to/alm/format"
	"github.com/a4to/alm/version"
)

// Client encapsulates client state for interacting with the alm
...
// port on which the alm service is listenting. The format of this variable
// is:
//
//	<scheme>://<host>:<port>
//
// If the variable is not specified, a default alm host and port will be
// used.
func ClientFromEnvironment() (*Client, error) {
	almHost := envconfig.Host

	return &Client{
		base: &url.URL{
			Scheme: almHost.Scheme,
			Host:   net.JoinHostPort(almHost.Host, almHost.Port),
		},
...
func (c *Client) do(ctx context.Context, method, path string, reqData, respData any) error {
	...
	request.Header.Set("User-Agent", fmt.Sprintf("alm/%s (%s %s) Go/%s", version.Version, runtime.GOARCH, runtime.GOOS, runtime.Version()))
...
// Pull downloads a model from the alm library. fn is called each time
...
// Push uploads a model to the model library; requires registering for alm.ai
...
//
// [Modelfile]: https://github.com/a4to/alm/blob/main/docs/modelfile.md
