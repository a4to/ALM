...
2. `alm create choose-a-model-name -f <location of the file e.g. ./Modelfile>'`
3. `alm run choose-a-model-name`
4. Start using the model!

More examples are available in the [examples directory](../examples).

To view the Modelfile of a given model, use the `alm show --modelfile` command.

  ```bash
  > alm show --modelfile llama3
  # Modelfile generated by "alm show"
  # To build a new Modelfile based on this one, replace the FROM line with:
  # FROM llama3:latest
  FROM /Users/pdevine/.alm/models/blobs/sha256-00e1317cbf74d901080d7100f57580ba8dd8de57203072dc6f668324ba545f29
...
<https://github.com/a4to/alm#model-library>
