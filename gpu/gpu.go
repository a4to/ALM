...
func initCudaHandles() *cudaHandles {
	...
	// TODO - if the ALM build is CPU only, don't do these checks as they're irrelevant and confusing
	...
	for _, libPath := range nvcudaLibPaths {
		...
		if resp.err != nil {
			...
			case C.CUDA_ERROR_UNKNOWN:
				...
				slog.Warn("see https://github.com/a4to/ALM/blob/main/docs/troubleshooting.md for more information")
			default:
