	...
	for i := range count {
		...
		if gfxOverride == "" {
			if !slices.Contains[[]string, string](supported, gfx) {
				...
				slog.Warn("See https://github.com/a4to/ALM/blob/main/docs/troubleshooting.md for HSA_OVERRIDE_GFX_VERSION usage")
				continue
			} else {
...
func AMDValidateLibDir() (string, error) {
	...
	if rocmLibUsable(rocmTargetDir) {
		slog.Debug("detected ALM installed ROCm at " + rocmTargetDir)
