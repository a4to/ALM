...
1. Make sure you have the right model installed:
   ...
   ```bash
   alm pull stablebeluga2:70b-q4_K_M
   ```
...
3. Now you can create a model with this command:
   ...
   ```bash
   alm create <username>/lornegreene -f lornegreene/Modelfile
   ```

   `username` is whatever name you set up when you signed up at [https://alm.com/signup](https://alm.com/signup).
