...
#define MyAppURL "https://ALM.com/"
#define MyAppExeName "ALM app.exe"
...
Source: "..\ALM.exe"; DestDir: "{app}"; Flags: ignoreversion 64bit
Source: "..\dist\windows-{#ARCH}\ALM_runners\*"; DestDir: "{app}\ALM_runners"; Flags: ignoreversion 64bit recursesubdirs
Source: "..\dist\ALM_welcome.ps1"; DestDir: "{app}"; Flags: ignoreversion
...
; Filename: "{cmd}"; Parameters: "/C ""taskkill /im ALM.exe /f /t"; Flags: runhidden
Filename: "taskkill"; Parameters: "/im ""{#MyAppExeName}"" /f /t"; Flags: runhidden
Filename: "taskkill"; Parameters: "/im ""ALM.exe"" /f /t"; Flags: runhidden
...
[UninstallDelete]
Type: filesandordirs; Name: "{%TEMP}\ALM*"
Type: filesandordirs; Name: "{%LOCALAPPDATA}\Ollama"
Type: filesandordirs; Name: "{%LOCALAPPDATA}\Programs\Ollama"
Type: filesandordirs; Name: "{%USERPROFILE}\.ALM\models"
Type: filesandordirs; Name: "{%USERPROFILE}\.ALM\history"
...
;FinishedLabel=%nRun this command in a PowerShell or cmd terminal.%n%n%n    ALM run llama3
;ClickFinish=%n
