...
// TODO (https://github.com/a4to/ALM/issues/5259): support []string, []int and [][]int
...
func toChatCompletion(id string, r api.ChatResponse) ChatCompletion {
	return ChatCompletion{
		...
		Usage: Usage{
			// TODO: ALM returns 0 for prompt eval if the prompt was cached, but openai returns the actual count
